...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DqlkRiL5.mjs");
...
const manifest = {
  "097f348510fc447e149a418599038dbc26c42459204774046ec4e09b67af8635": {
    functionName: "formatAtaWithClaude_createServerFn_handler",
    importer: () => import("./format-ata.functions-C8nnn798.mjs")
  },
  "396ec2195f8f36010d13cff4d86b957ebf305db024ad438ebf67ec411374b67c": {
    functionName: "generateClientReport_createServerFn_handler",
    importer: () => import("./client-report.functions-BE6d3JBw.mjs")
  },
  "a787921ee7885a89f18e20f917552f25a52930cebb5359dea24b533512759549": {
    functionName: "formatNoteWithAI_createServerFn_handler",
    importer: () => import("./ai-format.functions-CitWjYp5.mjs")
  },
  "b3ad5d952d9f852d7cbe4262d7e8b7bc90ab391dde38df31563c103ded58bf1d": {
    functionName: "parseAtaWithClaude_createServerFn_handler",
    importer: () => import("./import-ata.functions-B81zjuRn.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DXKzFnT6.mjs").then((n) => n.z),
    import("./start-C8a64vnw.mjs"),
