...
import { u as useServerFn, c as createSsrRpc } from "./createSsrRpc-P_Avr5rK.mjs";
import { u as useAuth, g as useProfiles, e as useClients, i as useTaskTags, j as useTaskStatuses, C as Card, B as Button, I as Input } from "./router-DXKzFnT6.mjs";
...
import { a as Sparkles, Z as FileText, _ as Upload, D as LoaderCircle, $ as FilePenLine, N as NotebookPen, P as Plus, A as CircleCheck, T as Trash2 } from "../_libs/lucide-react.mjs";
...
const parseAtaWithClaude = createServerFn({
  method: "POST"
}).middleware([requireSupabaseAuth]).inputValidator((data) => InputSchema$1.parse(data)).handler(createSsrRpc("b3ad5d952d9f852d7cbe4262d7e8b7bc90ab391dde38df31563c103ded58bf1d"));
...
const formatAtaWithClaude = createServerFn({
  method: "POST"
}).middleware([requireSupabaseAuth]).inputValidator((data) => InputSchema.parse(data)).handler(createSsrRpc("097f348510fc447e149a418599038dbc26c42459204774046ec4e09b67af8635"));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-6xl p-4 md:p-6 space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: tab, onValueChange: (v) => setTab(v), children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "pdf", className: "mt-3 space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-3 rounded-md border border-dashed p-4 cursor-pointer hover:bg-muted/40", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "text", className: "mt-3 space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { rows: 10, placeholder: "Cole aqui o conteúdo da ata (ou a resposta do Claude com as próximas etapas)...", value: text, onChange: (e) => setText(e.target.value) }) })
      ] }),
