...
import { e as useClients, g as useAssignableProfiles, h as useColumns, S as Select, n as SelectTrigger, o as SelectValue, p as SelectContent, q as SelectItem, B as Button, I as Input, u as useAuth, j as useProfiles, l as useTaskStatuses, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, L as Label, F as FileDropZone, A as AttachmentPreviewDialog } from "./router-ZM7179_C.mjs";
import { P as Popover, a as PopoverTrigger, b as PopoverContent, c as RichTextEditor } from "./RichTextEditor-P9Iw8467.mjs";
...
import { r as Users, ak as UserCheck, ar as SquarePen, C as ChevronDown, X, ac as RotateCcw, as as Funnel, at as Clock3, ap as ChevronRight, f as Paperclip, D as Download, P as Plus, au as Send, av as Link2, E as ExternalLink, T as Trash2 } from "../_libs/lucide-react.mjs";
...
function TaskFilters({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-1.5 rounded-lg border bg-card p-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex rounded-md border bg-muted/40 p-0.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScopeBtn, { active: scope === "all", onClick: () => onChange({ ...filters, scope: void 0, assignee: void 0 }), icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-3.5 w-3.5" }), children: "Todas" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScopeBtn, { active: scope === "mine", onClick: () => onChange({ ...filters, scope: "mine", assignee: void 0 }), icon: /* @__PURE__ */ jsxRuntimeExports.jsx(UserCheck, { className: "h-3.5 w-3.5" }), children: "Atribuídas a mim" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScopeBtn, { active: scope === "created", onClick: () => onChange({ ...filters, scope: "created", assignee: void 0 }), icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SquarePen, { className: "h-3.5 w-3.5" }), children: "Criadas por mim" })
    ] }) }),
    ...
    !hideAssignee && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Select,
      {
      ...
      Select,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            ...
            columns.map((column) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: `${COLUMN_STATUS_PREFIX}${column.id}`, children: column.name }, column.id)),
...
function applyTaskFilters(tasks, f, opts) {
  ...
  return tasks.filter((t) => {
    if (opts?.restrictToCurrentUserParticipation) {
      if (!uid) return false;
      const participatesInTask = t.assignee_id === uid || !!subIds?.has(t.id) || !!collaboratorIds?.has(t.id);
...
function TaskDialog({ open, onOpenChange, task, defaultColumnId }) {
  ...
  const canManageCollaborators = !task || !!isAdmin || task.created_by === user?.id || task.assignee_id === user?.id;
  ...
  const [recurrenceDays, setRecurrenceDays] = reactExports.useState([]);
  ...
  const taskCreator = reactExports.useMemo(
  ...
  const loadCollaborators = async (taskId) => {
    ...
    setCollaboratorIds(
      (data ?? []).map((collaborator) => collaborator.collaborator_id)
    );
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-h-[90vh] max-w-3xl overflow-y-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-1 space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-6 space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border bg-muted/30 p-1.5 shadow-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              ...
              dueDate && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  type: "button",
                  size: "icon",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-5 space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { open: collaboratorPickerOpen, onOpenChange: setCollaboratorPickerOpen, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                title: canManageCollaborators ? void 0 : "Somente o criador ou responsável pode alterar colaboradores",
                children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverContent, { align: "start", className: "w-64 p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-56 space-y-0.5 overflow-y-auto", children: assignableProfiles.map((profile) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-2 space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-3 space-y-2", children: [
              ...
              PopoverContent,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                    ...
                    filteredClients.slice(0, 5).map((client) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        type: "button",
                        onClick: () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-4 space-y-2", children: [
          ...
          task && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Criada por" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm font-medium", children: taskCreator?.full_name || taskCreator?.email || "Usuário não identificado" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onClick: () => setRecurrenceDays(
                    active ? recurrenceDays.filter((d) => d !== idx) : [...recurrenceDays, idx].sort()
                  ),
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    ...
                    onChange: (e) => setRecurrenceOffsets({
                      ...recurrenceOffsets,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "subtasks", children: [
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 rounded-md border bg-muted/30 px-3 py-2", children: [
              ...
              expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-6 space-y-2 border-l pl-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  ...
                  files.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    FileDropZone,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex cursor-pointer items-center justify-center gap-2 rounded border border-dashed py-1.5 text-[11px] text-muted-foreground hover:bg-muted/40", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "files", className: "space-y-2", children: [
          attachments.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                a.mime_type !== LINK_MIME && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    size: "icon",
                    variant: "ghost",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            FileDropZone,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex cursor-pointer items-center justify-center gap-2 rounded-md border border-dashed py-3 text-sm text-muted-foreground hover:bg-muted/40", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between gap-2 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: currentTaskId && canDeleteTask && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            variant: "ghost",
            onClick: remove,
