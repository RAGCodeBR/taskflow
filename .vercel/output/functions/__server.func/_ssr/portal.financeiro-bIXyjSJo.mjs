...
import { e as useClients, z as useClientInvoices, u as useAuth, B as Button, C as Card, S as Select, n as SelectTrigger, o as SelectValue, p as SelectContent, q as SelectItem, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, L as Label, I as Input, d as DialogFooter, F as FileDropZone, x as cn, y as buttonVariants } from "./router-ZM7179_C.mjs";
...
import { P as Plus, b as Pencil, T as Trash2, aq as Copy, F as FileText, f as Paperclip } from "../_libs/lucide-react.mjs";
...
function DocumentPicker({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(FileDropZone, { onFiles: (files) => onPick(files.item(0)), className: "flex flex-wrap items-center gap-2", children: [
