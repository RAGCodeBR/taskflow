...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Er00vbVL.mjs");
...
const manifest = {
  "1ac0227fbe0dd79474df6631419249d0757766cdf1dcd6aeac31ad2535735f89": {
    functionName: "formatAtaWithGemini_createServerFn_handler",
    importer: () => import("./format-ata.functions-B_NbwsoP.mjs")
  },
  "262ce3ed5de3ddc963412f4728b292b329875f4bebdabf2e54153fe103370b1f": {
    functionName: "parseAtaWithGemini_createServerFn_handler",
    importer: () => import("./import-ata.functions-BlD-lB3O.mjs")
  },
  "396ec2195f8f36010d13cff4d86b957ebf305db024ad438ebf67ec411374b67c": {
    functionName: "generateClientReport_createServerFn_handler",
    importer: () => import("./client-report.functions-CvmOtqRQ.mjs")
  },
  "a787921ee7885a89f18e20f917552f25a52930cebb5359dea24b533512759549": {
    functionName: "formatNoteWithAI_createServerFn_handler",
    importer: () => import("./ai-format.functions-B3HH2U7n.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ZM7179_C.mjs").then((n) => n.P),
    import("./start-BFqgtimB.mjs"),
