...
import { u as useAuth, f as useTasks, j as useProfiles, e as useClients, l as useTaskStatuses, S as Select, n as SelectTrigger, o as SelectValue, p as SelectContent, q as SelectItem, C as Card } from "./router-ZM7179_C.mjs";
import { s as supabase } from "./client-Bh9iiLf9.mjs";
import { B as Badge } from "./badge-D8s76cXv.mjs";
import { D as DateFilterBar } from "./DateFilterBar-hyCFWgXd.mjs";
import { m as matchDateFilter } from "./task-utils-DZ472SbJ.mjs";
import "../_libs/sonner.mjs";
import "../_libs/marked.mjs";
import "../_libs/seroval.mjs";
import { l as isAfter, a as parseISO } from "../_libs/date-fns.mjs";
import { a4 as ListTodo, a1 as CircleCheck, a2 as Clock, a3 as TriangleAlert, l as ListChecks, af as ShieldCheck, ag as User } from "../_libs/lucide-react.mjs";
...
function ReportsPage() {
  ...
  if (!hasPermission("reports")) return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/dashboard" });
  const matchesStatus = (p) => {
    const active = p.is_active !== false;
    return statusFilter === "all" || (statusFilter === "active" ? active : !active);
  };
  const clientUserIds = new Set(roles.filter((role) => role.role === "client").map((role) => role.user_id));
