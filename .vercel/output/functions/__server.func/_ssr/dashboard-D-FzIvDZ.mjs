...
import { u as useAuth, f as useTasks, e as useClients, g as useAssignableProfiles, h as useColumns, C as Card } from "./router-ZM7179_C.mjs";
...
import { a2 as Clock, a3 as TriangleAlert, a4 as ListTodo, a1 as CircleCheck } from "../_libs/lucide-react.mjs";
...
function Dashboard() {
  ...
  const byUser = reactExports.useMemo(() => assignableProfiles.map((p) => ({
